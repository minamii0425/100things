...
const ProfilesHandler = async (req, res)=>{
    ...
    if (req.method === "GET") {
        console.log("ゲット");
        const results = await _libs_prisma__WEBPACK_IMPORTED_MODULE_0__/* ["default"].profiles.findMany */ .Z.profiles.findMany({});
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (ProfilesHandler);
...
var __webpack_exports__ = (__webpack_exec__(7590));
